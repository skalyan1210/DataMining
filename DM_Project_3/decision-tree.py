...
# Function to get metrics - TP,FP,TN,FN for calculating accuracy/precision/recall/f-measure
...
print(data)
print(data[:, -1])
class_label = data[:, -1].reshape((data.shape[0], 1)).astype(int)
#print(class_label)
data = data[:, 0:-1]
print(data)
...
data = np.append(data, class_label, axis=1)
